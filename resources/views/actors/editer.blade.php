...
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-10 ">
            <h1 class="fa fa-plus">editer des acteurs</h1>
            ...
            <div >
                ...
                <form method="post" enctype="multipart/form-data" action="{{route('actors_enregistrer')}}">
                    ...
                    <p>
                        ...
                        <input name="firstname" id="firstname"  class="form-control" value=""/>
                    </p>
                    ...
                    <button type="submit" class="btn btn-rounded btn-info btn-block boutoncreer">editer un acteur</button>
                    <div class="col-xs-12 col-sm-6 col-md-1 ">
                    </div>
            </div>
        </div>

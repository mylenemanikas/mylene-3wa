                ...
                <div class="col-xs-12 col-sm-6 col-md-10 ">
                        ...
                        <div >
                                ...
                                <form method="post" enctype="multipart/form-data" action="{{route('movies_modifier', ['id' => $movies->id])}}">
                                        ...
                                        <input @if($movies->languages=="en") checked @endif name="langue" id="inlineRadio1"  value="en"  type="radio" />en


                                        <input @if($movies->languages=="fr") checked @endif name="langue" id="inlineRadio2" value="fr" type="radio">fr

                                        <input @if($movies->languages=="es") checked @endif name="langue" id="inlineRadio3" value="es" type="radio">es
                                        ...
                                        <input @if($movies->bo=="vo") checked @endif name="bo" id="inlineRadio4" value="{{$movies->bo}}" type="radio">vo


                                        <input @if($movies->bo=="vost") checked @endif name="bo" id="inlineRadio5" value="{{$movies->bo}}" type="radio">vost

                                        <input @if($movies->bo=="vostfr") checked @endif name="bo" id="inlineRadio6" value="{{$movies->bo}}" type="radio">vostfr
